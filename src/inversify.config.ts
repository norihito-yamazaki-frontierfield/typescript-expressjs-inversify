...
container.bind<IExampleService>('IExampleService').to(ExampleService).inSingletonScope();
container.bind<IKeycloakService>('IKeycloakService').to(KeycloakService).inSingletonScope();
